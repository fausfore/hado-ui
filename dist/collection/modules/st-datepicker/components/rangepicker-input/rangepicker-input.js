    ...
    render() {
        ...
        return (h("div", { class: 'oui-datepicker' },
            h("div", { class: "datepicker-range-input" },
                h("input-form", { onClick: () => this.toggleRangePickerModal('start'), value: this.getLabel(rangeStartValue), placeholder: placeholder, iconClass: calendarIconClass }),
                h("input-form", { onClick: () => this.toggleRangePickerModal('end'), value: this.getLabel(rangeEndValue), placeholder: placeholder_2, iconClass: calendarIconClass }),
                this.openDatePicker
