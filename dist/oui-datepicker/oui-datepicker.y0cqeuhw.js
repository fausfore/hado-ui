...
var s=document.querySelector("script[data-namespace='oui-datepicker']");if(s){publicPath=s.getAttribute('data-path');}
(function(publicPath){
    /** OuiDatepicker global **/
